...
/// long and the worker falls behind, Nala should catch up to what's
...
/// the event sink and the `Assistant` both speak through one `AsyncSpeech`
/// and have the final answer come out after any in-flight narration,
