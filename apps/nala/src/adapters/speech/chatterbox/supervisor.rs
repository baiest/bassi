...
/// Owns the Chatterbox server process this instance of Nala started, if
/// any, and kills it on drop. If Nala found an already-running server
/// instead, no child is owned and dropping this does nothing to it - that
/// server is left for whoever started it.
