...
use crate::types::{McpClient, McpError, McpToolInfo, McpToolResult};
...
impl<T: Transport> StdioMcpClient<T> {
    ...
    fn request(&mut self, method: &str, params: Value) -> Result<Value, McpError> {
        ...
        // or responses to other in-flight requests between our request and
        // its actual response. Keep reading until a message carries this
        // request's id.
        loop {
