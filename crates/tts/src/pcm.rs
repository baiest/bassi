...
/// Turns text into a streamed PCM result. Implementations should return as
/// soon as the audio format is known, so the caller can start playing
/// chunks while synthesis is still producing more.
